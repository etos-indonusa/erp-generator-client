...
export function partActypeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartActypeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
