...
export function partidControllerFindAll(http: HttpClient, rootUrl: string, params?: PartidControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
