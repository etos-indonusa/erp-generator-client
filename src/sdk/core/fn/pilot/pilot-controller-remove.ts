...
export function pilotControllerRemove(http: HttpClient, rootUrl: string, params: PilotControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPilotDto;
}>> {
