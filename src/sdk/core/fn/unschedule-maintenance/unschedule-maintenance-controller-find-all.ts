...
export interface UnscheduleMaintenanceControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function unscheduleMaintenanceControllerFindAll(http: HttpClient, rootUrl: string, params?: UnscheduleMaintenanceControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
