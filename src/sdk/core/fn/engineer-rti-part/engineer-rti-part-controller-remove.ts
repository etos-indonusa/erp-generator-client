...
export function engineerRtiPartControllerRemove(http: HttpClient, rootUrl: string, params: EngineerRtiPartControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
