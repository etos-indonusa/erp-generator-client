...
export function engineerRtiPartControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerRtiPartControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
