...
export interface StockWidgetControllerFindAll$Params {
...
export function stockWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StockWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
