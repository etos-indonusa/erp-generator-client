...
export function mpartControllerUpdate(http: HttpClient, rootUrl: string, params: MpartControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpartDto;
}>> {
