...
export function engineerRtiPartWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerRtiPartWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
