...
export function purVendorWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurVendorWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
