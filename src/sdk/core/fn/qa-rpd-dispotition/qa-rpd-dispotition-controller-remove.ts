...
export function qaRpdDispotitionControllerRemove(http: HttpClient, rootUrl: string, params: QaRpdDispotitionControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
