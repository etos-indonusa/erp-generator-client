...
export function internalGrnControllerFindOne(http: HttpClient, rootUrl: string, params: InternalGrnControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
