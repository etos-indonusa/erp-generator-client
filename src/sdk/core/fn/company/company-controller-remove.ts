...
export function companyControllerRemove(http: HttpClient, rootUrl: string, params: CompanyControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
