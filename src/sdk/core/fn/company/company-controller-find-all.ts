...
export function companyControllerFindAll(http: HttpClient, rootUrl: string, params?: CompanyControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
