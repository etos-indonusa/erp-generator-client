...
export function moduleControllerFindAll(http: HttpClient, rootUrl: string, params?: ModuleControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
moduleControllerFindAll.PATH = '/nonauth/module/module';
