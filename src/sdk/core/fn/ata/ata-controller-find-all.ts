...
export function ataControllerFindAll(http: HttpClient, rootUrl: string, params?: AtaControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
