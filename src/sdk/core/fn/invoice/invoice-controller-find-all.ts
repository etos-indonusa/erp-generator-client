...
export function invoiceControllerFindAll(http: HttpClient, rootUrl: string, params?: InvoiceControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
invoiceControllerFindAll.PATH = '/nonauth/invoice/invoice';
