...
export function mcurrencyControllerRemove(http: HttpClient, rootUrl: string, params: McurrencyControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
