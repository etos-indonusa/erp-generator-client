...
export function mcurrencyControllerUpdate(http: HttpClient, rootUrl: string, params: McurrencyControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
