...
export function purReturnControllerFindOne(http: HttpClient, rootUrl: string, params: PurReturnControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
