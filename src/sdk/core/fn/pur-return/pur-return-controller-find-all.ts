...
export function purReturnControllerFindAll(http: HttpClient, rootUrl: string, params?: PurReturnControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
