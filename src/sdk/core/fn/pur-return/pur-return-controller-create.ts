...
export function purReturnControllerCreate(http: HttpClient, rootUrl: string, params: PurReturnControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
