...
export function workflowLogReportControllerFindAll(http: HttpClient, rootUrl: string, params: WorkflowLogReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
