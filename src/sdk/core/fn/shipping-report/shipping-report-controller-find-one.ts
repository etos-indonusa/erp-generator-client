...
export function shippingReportControllerFindOne(http: HttpClient, rootUrl: string, params: ShippingReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
