...
export function purVendorItemControllerFindAll(http: HttpClient, rootUrl: string, params?: PurVendorItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
