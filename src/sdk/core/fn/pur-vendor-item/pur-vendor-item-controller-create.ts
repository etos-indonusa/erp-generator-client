...
export function purVendorItemControllerCreate(http: HttpClient, rootUrl: string, params: PurVendorItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
