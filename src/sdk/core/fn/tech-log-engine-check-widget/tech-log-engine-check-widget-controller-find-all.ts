...
export function techLogEngineCheckWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogEngineCheckWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
