...
export interface VDueListOutputControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function vDueListOutputControllerFindAll(http: HttpClient, rootUrl: string, params?: VDueListOutputControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
