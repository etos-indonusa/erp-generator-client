...
export function engineerPmtrItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPmtrItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
