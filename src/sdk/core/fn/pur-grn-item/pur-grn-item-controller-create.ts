...
export function purGrnItemControllerCreate(http: HttpClient, rootUrl: string, params: PurGrnItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
