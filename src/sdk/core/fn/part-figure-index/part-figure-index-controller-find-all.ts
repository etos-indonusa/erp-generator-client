...
export function partFigureIndexControllerFindAll(http: HttpClient, rootUrl: string, params?: PartFigureIndexControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
