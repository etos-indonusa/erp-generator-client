...
export function partFigureIndexControllerCreate(http: HttpClient, rootUrl: string, params: PartFigureIndexControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
