...
export function partFigureIndexControllerUpdate(http: HttpClient, rootUrl: string, params: PartFigureIndexControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
