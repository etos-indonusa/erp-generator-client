...
export function partFigureIndexControllerFindOne(http: HttpClient, rootUrl: string, params: PartFigureIndexControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
