...
export function conditionMonitoringControllerFindOne(http: HttpClient, rootUrl: string, params: ConditionMonitoringControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
