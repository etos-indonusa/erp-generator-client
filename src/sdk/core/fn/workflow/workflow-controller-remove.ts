...
export function workflowControllerRemove(http: HttpClient, rootUrl: string, params: WorkflowControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
