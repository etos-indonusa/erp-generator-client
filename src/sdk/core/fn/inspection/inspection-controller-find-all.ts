...
export function inspectionControllerFindAll(http: HttpClient, rootUrl: string, params?: InspectionControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
