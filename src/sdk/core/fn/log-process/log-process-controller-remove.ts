...
export function logProcessControllerRemove(http: HttpClient, rootUrl: string, params: LogProcessControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
