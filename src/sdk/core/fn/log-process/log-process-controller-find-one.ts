...
export function logProcessControllerFindOne(http: HttpClient, rootUrl: string, params: LogProcessControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
