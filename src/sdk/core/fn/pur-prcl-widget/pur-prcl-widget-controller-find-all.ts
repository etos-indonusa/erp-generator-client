...
export function purPrclWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurPrclWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
