...
export function libUploadControllerUpdate(http: HttpClient, rootUrl: string, params: LibUploadControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
