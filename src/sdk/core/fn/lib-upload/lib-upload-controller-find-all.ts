...
export function libUploadControllerFindAll(http: HttpClient, rootUrl: string, params?: LibUploadControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
