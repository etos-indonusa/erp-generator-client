...
export function techLogItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
