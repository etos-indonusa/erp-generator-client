...
export function rotaryFactorControllerRemove(http: HttpClient, rootUrl: string, params: RotaryFactorControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
