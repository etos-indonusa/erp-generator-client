...
export function workflowAggregatorControllerUpdate(http: HttpClient, rootUrl: string, params: WorkflowAggregatorControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
