...
export function workflowAggregatorControllerFindOne(http: HttpClient, rootUrl: string, params: WorkflowAggregatorControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
