...
export function tdTypeControllerUpdate(http: HttpClient, rootUrl: string, params: TdTypeControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsTdTypeDto;
}>> {
