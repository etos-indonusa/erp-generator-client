...
export function customFieldGroupControllerCreate(http: HttpClient, rootUrl: string, params: CustomFieldGroupControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
