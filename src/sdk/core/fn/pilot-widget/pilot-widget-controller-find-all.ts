...
export function pilotWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PilotWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
