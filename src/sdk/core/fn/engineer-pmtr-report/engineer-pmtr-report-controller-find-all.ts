...
export function engineerPmtrReportControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPmtrReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
