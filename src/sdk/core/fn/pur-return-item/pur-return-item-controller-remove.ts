...
export function purReturnItemControllerRemove(http: HttpClient, rootUrl: string, params: PurReturnItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
