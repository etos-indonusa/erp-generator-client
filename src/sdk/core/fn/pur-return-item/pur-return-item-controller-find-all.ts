...
export function purReturnItemControllerFindAll(http: HttpClient, rootUrl: string, params?: PurReturnItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
