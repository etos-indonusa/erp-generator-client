...
export function tdDetailControllerCreate(http: HttpClient, rootUrl: string, params: TdDetailControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
