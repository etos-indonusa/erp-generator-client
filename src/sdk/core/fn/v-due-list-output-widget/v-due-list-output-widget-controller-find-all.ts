...
export interface VDueListOutputWidgetControllerFindAll$Params {
...
export function vDueListOutputWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: VDueListOutputWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
