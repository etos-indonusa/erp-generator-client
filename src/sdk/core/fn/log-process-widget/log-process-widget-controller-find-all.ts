...
export function logProcessWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogProcessWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
