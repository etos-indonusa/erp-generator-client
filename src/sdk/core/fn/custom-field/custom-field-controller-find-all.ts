...
export function customFieldControllerFindAll(http: HttpClient, rootUrl: string, params?: CustomFieldControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
customFieldControllerFindAll.PATH = '/nonauth/custom_field/custom_field';
