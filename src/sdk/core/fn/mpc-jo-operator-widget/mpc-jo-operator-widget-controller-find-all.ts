...
export function mpcJoOperatorWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcJoOperatorWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
