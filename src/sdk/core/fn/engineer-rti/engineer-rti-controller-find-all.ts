...
export function engineerRtiControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerRtiControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
