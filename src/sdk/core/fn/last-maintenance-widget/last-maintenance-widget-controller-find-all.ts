...
export function lastMaintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LastMaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
