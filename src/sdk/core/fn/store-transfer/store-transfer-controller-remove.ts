...
export function storeTransferControllerRemove(http: HttpClient, rootUrl: string, params: StoreTransferControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
