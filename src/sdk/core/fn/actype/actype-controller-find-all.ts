...
export function actypeControllerFindAll(http: HttpClient, rootUrl: string, params?: ActypeControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
