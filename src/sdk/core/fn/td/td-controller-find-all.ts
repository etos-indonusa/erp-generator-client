...
export function tdControllerFindAll(http: HttpClient, rootUrl: string, params?: TdControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
