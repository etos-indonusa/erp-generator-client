...
export function tdDetailAcControllerRemove(http: HttpClient, rootUrl: string, params: TdDetailAcControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
