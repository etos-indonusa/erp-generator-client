...
export function techLogJoControllerFindAll(http: HttpClient, rootUrl: string, params?: TechLogJoControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
