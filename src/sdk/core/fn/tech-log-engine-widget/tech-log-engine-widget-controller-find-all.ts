...
export function techLogEngineWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogEngineWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
