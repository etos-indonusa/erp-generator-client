...
export function doctypeControllerFindOne(http: HttpClient, rootUrl: string, params: DoctypeControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
