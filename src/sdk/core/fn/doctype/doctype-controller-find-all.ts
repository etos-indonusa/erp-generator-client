...
export function doctypeControllerFindAll(http: HttpClient, rootUrl: string, params?: DoctypeControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
