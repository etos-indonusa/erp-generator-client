...
export function partidReportControllerFindOne(http: HttpClient, rootUrl: string, params: PartidReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
