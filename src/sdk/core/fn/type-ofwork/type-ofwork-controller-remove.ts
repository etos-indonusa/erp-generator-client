...
export function typeOfworkControllerRemove(http: HttpClient, rootUrl: string, params: TypeOfworkControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
