...
export function purPrItemReportControllerFindAll(http: HttpClient, rootUrl: string, params: PurPrItemReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
