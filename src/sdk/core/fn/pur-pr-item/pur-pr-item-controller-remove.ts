...
export function purPrItemControllerRemove(http: HttpClient, rootUrl: string, params: PurPrItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
