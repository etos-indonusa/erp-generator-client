...
export function purPrItemControllerUpdate(http: HttpClient, rootUrl: string, params: PurPrItemControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
