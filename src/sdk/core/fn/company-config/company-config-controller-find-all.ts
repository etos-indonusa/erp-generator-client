...
export interface CompanyConfigControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function companyConfigControllerFindAll(http: HttpClient, rootUrl: string, params?: CompanyConfigControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
companyConfigControllerFindAll.PATH = '/nonauth/company_config/company_config';
