...
export function mpcJoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcJoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
