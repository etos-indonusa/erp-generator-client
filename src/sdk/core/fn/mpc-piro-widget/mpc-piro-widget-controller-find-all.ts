...
export function mpcPiroWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcPiroWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
