...
export function storeTransferItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StoreTransferItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
