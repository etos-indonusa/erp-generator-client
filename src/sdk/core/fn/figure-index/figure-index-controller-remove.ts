...
export function figureIndexControllerRemove(http: HttpClient, rootUrl: string, params: FigureIndexControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
