...
export function figureIndexControllerFindAll(http: HttpClient, rootUrl: string, params?: FigureIndexControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
