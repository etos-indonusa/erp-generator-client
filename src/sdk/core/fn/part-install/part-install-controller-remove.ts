...
export function partInstallControllerRemove(http: HttpClient, rootUrl: string, params: PartInstallControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
