...
export function usersReportControllerFindAll(http: HttpClient, rootUrl: string, params: UsersReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
