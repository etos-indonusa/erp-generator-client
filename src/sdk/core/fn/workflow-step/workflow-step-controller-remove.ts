...
export function workflowStepControllerRemove(http: HttpClient, rootUrl: string, params: WorkflowStepControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
