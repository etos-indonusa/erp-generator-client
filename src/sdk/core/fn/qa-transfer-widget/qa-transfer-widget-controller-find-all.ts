...
export function qaTransferWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaTransferWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
