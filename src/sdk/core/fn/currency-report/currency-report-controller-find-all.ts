...
export function currencyReportControllerFindAll(http: HttpClient, rootUrl: string, params: CurrencyReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
