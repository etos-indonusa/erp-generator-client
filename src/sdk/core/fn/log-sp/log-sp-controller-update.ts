...
export function logSpControllerUpdate(http: HttpClient, rootUrl: string, params: LogSpControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsLogSpDto;
}>> {
