...
export function techDiscrepanciesControllerFindOne(http: HttpClient, rootUrl: string, params: TechDiscrepanciesControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
