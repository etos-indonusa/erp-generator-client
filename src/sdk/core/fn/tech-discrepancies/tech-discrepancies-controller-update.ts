...
export function techDiscrepanciesControllerUpdate(http: HttpClient, rootUrl: string, params: TechDiscrepanciesControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
