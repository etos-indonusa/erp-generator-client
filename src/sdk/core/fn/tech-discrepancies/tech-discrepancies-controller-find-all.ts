...
export function techDiscrepanciesControllerFindAll(http: HttpClient, rootUrl: string, params?: TechDiscrepanciesControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
