...
export interface StockControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function stockControllerFindAll(http: HttpClient, rootUrl: string, params?: StockControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
