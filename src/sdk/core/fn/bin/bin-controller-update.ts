...
export function binControllerUpdate(http: HttpClient, rootUrl: string, params: BinControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsBinDto;
}>> {
