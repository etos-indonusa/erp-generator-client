...
export function purPrControllerFindAll(http: HttpClient, rootUrl: string, params?: PurPrControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
