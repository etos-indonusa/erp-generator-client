...
export function tdTypeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TdTypeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
