...
export function positionReportControllerFindOne(http: HttpClient, rootUrl: string, params: PositionReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
