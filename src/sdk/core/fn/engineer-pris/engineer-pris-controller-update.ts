...
export function engineerPrisControllerUpdate(http: HttpClient, rootUrl: string, params: EngineerPrisControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
