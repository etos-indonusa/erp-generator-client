...
export function aircraftControllerCreate(http: HttpClient, rootUrl: string, params: AircraftControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
