...
export function aircraftControllerRemove(http: HttpClient, rootUrl: string, params: AircraftControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
