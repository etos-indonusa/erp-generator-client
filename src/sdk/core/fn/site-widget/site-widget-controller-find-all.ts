...
export function siteWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: SiteWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
