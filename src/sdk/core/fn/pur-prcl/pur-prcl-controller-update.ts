...
export function purPrclControllerUpdate(http: HttpClient, rootUrl: string, params: PurPrclControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
