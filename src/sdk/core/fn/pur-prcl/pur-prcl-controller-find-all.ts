...
export function purPrclControllerFindAll(http: HttpClient, rootUrl: string, params?: PurPrclControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
