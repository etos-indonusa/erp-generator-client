...
export function engineerPrisReturnItemControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerPrisReturnItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
