...
export function engineerPrisReturnItemControllerRemove(http: HttpClient, rootUrl: string, params: EngineerPrisReturnItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
