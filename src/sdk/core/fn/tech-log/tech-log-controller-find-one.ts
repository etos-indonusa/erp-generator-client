...
export function techLogControllerFindOne(http: HttpClient, rootUrl: string, params: TechLogControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
