...
export function aircraftDetailControllerFindAll(http: HttpClient, rootUrl: string, params?: AircraftDetailControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
