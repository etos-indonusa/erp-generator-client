...
export function dueListOutputReportControllerFindAll(http: HttpClient, rootUrl: string, params: DueListOutputReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
