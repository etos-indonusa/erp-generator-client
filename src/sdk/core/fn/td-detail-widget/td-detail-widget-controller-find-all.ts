...
export function tdDetailWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TdDetailWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
