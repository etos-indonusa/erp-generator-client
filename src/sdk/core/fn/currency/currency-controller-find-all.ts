...
export function currencyControllerFindAll(http: HttpClient, rootUrl: string, params?: CurrencyControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
