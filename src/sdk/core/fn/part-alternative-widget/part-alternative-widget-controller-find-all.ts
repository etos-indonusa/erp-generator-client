...
export function partAlternativeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartAlternativeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
