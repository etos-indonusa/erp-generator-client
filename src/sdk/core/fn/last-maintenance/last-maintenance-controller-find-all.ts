...
export function lastMaintenanceControllerFindAll(http: HttpClient, rootUrl: string, params?: LastMaintenanceControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
