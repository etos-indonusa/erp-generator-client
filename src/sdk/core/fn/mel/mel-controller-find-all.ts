...
export function melControllerFindAll(http: HttpClient, rootUrl: string, params?: MelControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
