...
export function melControllerUpdate(http: HttpClient, rootUrl: string, params: MelControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMelDto;
}>> {
