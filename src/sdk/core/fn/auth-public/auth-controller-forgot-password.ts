...
export function authControllerForgotPassword(http: HttpClient, rootUrl: string, params?: AuthControllerForgotPassword$Params, context?: HttpContext): Observable<StrictHttpResponse<SimpleMessageDto>> {
