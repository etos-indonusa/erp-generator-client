...
export function partActypeControllerFindOne(http: HttpClient, rootUrl: string, params: PartActypeControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
