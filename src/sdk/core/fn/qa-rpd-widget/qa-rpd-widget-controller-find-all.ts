...
export function qaRpdWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaRpdWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
