...
export function partAtaControllerCreate(http: HttpClient, rootUrl: string, params: PartAtaControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
