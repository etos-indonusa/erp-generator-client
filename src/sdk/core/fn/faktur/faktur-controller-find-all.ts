...
export interface FakturControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function fakturControllerFindAll(http: HttpClient, rootUrl: string, params?: FakturControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
fakturControllerFindAll.PATH = '/nonauth/faktur/faktur';
