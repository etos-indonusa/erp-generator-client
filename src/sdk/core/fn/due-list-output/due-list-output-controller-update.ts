...
export function dueListOutputControllerUpdate(http: HttpClient, rootUrl: string, params: DueListOutputControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
