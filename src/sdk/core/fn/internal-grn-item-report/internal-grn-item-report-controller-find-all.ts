...
export function internalGrnItemReportControllerFindAll(http: HttpClient, rootUrl: string, params: InternalGrnItemReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
