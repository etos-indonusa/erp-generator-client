...
export function mpcPiroItemControllerRemove(http: HttpClient, rootUrl: string, params: MpcPiroItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
