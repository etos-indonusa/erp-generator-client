...
export function mpcPiroItemControllerCreate(http: HttpClient, rootUrl: string, params: MpcPiroItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
