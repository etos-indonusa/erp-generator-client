...
export function storeTransferItemControllerUpdate(http: HttpClient, rootUrl: string, params: StoreTransferItemControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
