...
export function customFieldValueControllerFindAll(http: HttpClient, rootUrl: string, params?: CustomFieldValueControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
customFieldValueControllerFindAll.PATH = '/nonauth/custom_field_value/custom_field_value';
