...
export function engineerPmtrControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPmtrControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
