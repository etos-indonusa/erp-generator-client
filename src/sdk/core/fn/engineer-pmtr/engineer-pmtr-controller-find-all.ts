...
export function engineerPmtrControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerPmtrControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
