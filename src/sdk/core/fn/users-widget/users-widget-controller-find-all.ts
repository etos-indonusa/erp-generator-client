...
export function usersWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: UsersWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
