...
export function maintenanceCodeControllerRemove(http: HttpClient, rootUrl: string, params: MaintenanceCodeControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
