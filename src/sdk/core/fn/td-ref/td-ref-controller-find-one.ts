...
export function tdRefControllerFindOne(http: HttpClient, rootUrl: string, params: TdRefControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsTdRefDto;
}>> {
