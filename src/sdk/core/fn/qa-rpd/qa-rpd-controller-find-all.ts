...
export function qaRpdControllerFindAll(http: HttpClient, rootUrl: string, params?: QaRpdControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
