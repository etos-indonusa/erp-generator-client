...
export function techDefectControllerUpdate(http: HttpClient, rootUrl: string, params: TechDefectControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
