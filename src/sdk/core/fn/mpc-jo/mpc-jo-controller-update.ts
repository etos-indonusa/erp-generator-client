...
export function mpcJoControllerUpdate(http: HttpClient, rootUrl: string, params: MpcJoControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpcJoDto;
}>> {
