...
export function userGroupControllerFindAll(http: HttpClient, rootUrl: string, params?: UserGroupControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
userGroupControllerFindAll.PATH = '/nonauth/user_group/user_group';
