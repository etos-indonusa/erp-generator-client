...
export function techLogEngineControllerCreate(http: HttpClient, rootUrl: string, params: TechLogEngineControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
