...
export function authProtectedControllerGetMe(http: HttpClient, rootUrl: string, params?: AuthProtectedControllerGetMe$Params, context?: HttpContext): Observable<StrictHttpResponse<CurrentUserResponseDto>> {
