...
export function documentControllerFindAll(http: HttpClient, rootUrl: string, params?: DocumentControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
documentControllerFindAll.PATH = '/nonauth/document/document';
