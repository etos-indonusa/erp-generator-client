...
import { DocumentDocumentDto } from 'de-sdk-core';
...
@Component({
    selector: 'document-widget-v1',
    templateUrl: './widget-v1.component.html',
    styleUrl: './widget-v1.component.scss'
})
export class WidgetV1Component {
    @Input('for-module') forModule!: string | undefined;
    @Input('for-module-id') forModuleId!: string | undefined;
