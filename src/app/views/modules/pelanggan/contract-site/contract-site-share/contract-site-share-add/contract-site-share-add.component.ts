...
import { PelangganContractSiteFormSchema } from 'src/sdk/core/form-schema/pelanggan-contract-site.form-schema'; 
import type  { PelangganContractSiteDto } from 'src/sdk/core/models';
...
export class ContractSiteShareAddComponent {
    @Input('contractSite') contractSite: PelangganContractSiteDto = {
  idClientSite: '',
  idContract: '',
  idContractSite: ''
};
    ...
    ngOnInit(): void {
        this.form = generateFormFromSchema(this.fb, PelangganContractSiteFormSchema, {
    ...
    submit(): void {
        const labelMap = extractLabels(PelangganContractSiteFormSchema);
