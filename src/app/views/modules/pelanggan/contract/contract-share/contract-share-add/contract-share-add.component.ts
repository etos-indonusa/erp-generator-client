...
import { PelangganContractFormSchema } from 'src/sdk/core/form-schema/pelanggan-contract.form-schema'; 
import type  { PelangganContractDto } from 'src/sdk/core/models';
...
export class ContractShareAddComponent {
    @Input('contract') contract: PelangganContractDto = {
  idClient: '',
  idContract: ''
};
    form!: FormGroup;
    ...
    ngOnInit(): void {
        this.form = generateFormFromSchema(this.fb, PelangganContractFormSchema, {
    ...
    submit(): void {
        const labelMap = extractLabels(PelangganContractFormSchema);
