...
import { PartAlternativeReportService, PartAlternativeService } from 'src/sdk/core/services';
import { AmimsPartAlternativeDto } from 'src/sdk/core/models';
...
@Component({
    selector: 'app-part-alternative-share-list',
    templateUrl: './part-alternative-share-list.component.html',
    styleUrl: './part-alternative-share-list.component.scss'
})
export class PartAlternativeShareListComponent {
    ...
    searchData(reset: boolean = false): void {
        ...
        finalFilter[`id_part_alternative`] = { isNotNull: 'aktif' };

        this.partAlternativeReportService.partAlternativeReportControllerFindAll({
            body: {
                filter: finalFilter,
                joinWhere: [
                                        {
                ...
                include:  [
  {
    ...
    onColumnToggle(): void {
        localStorage.setItem('partAlternative_columns', JSON.stringify(this.columns));
    }
