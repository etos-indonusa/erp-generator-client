...
import { PartReportService, PartService } from 'de-sdk-core/lib/services';
import { AmimsPartDto } from 'de-sdk-core/lib/models';
...
export class PartShareListComponent {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        this.filter.status_part = this.status == 'semua' ? null : this.status;
        ...
        this.partReportService.partReportControllerFindAll({
            body: {
                ...
                joinWhere: [
                    ...
                    {
                        "group": this.filterGroup, type: 'inner'
                    },
                    {
                        "life_time_limit": this.filterLifeTimeLimit, type: 'inner'
                    },
                    {
                        "part_category": this.filterPartCategory, type: 'inner'
                    },
                    {
    ...
    columns = [
        ...
        { key: 'descriptionMpart', show: true },
        { key: 'forAc', show: true },
        { key: 'isDeleted', show: true },
        { key: 'isMandatory', show: true },
        { key: 'ismayor', show: true },
        ...
        { key: 'manufactureMpart', show: true },
        { key: 'mat_82', show: true },
        { key: 'mfigureIndex', show: true },
        { key: 'minQty', show: true },
        { key: 'mitemIndex', show: true },
        { key: 'mtboCycle', show: true },
        { key: 'mtboHours', show: true },
        { key: 'mtboVal', show: true },
        { key: 'mtboVar', show: true },
        { key: 'oldAtachapter', show: true },
        { key: 'oldId', show: true },
        { key: 'parent', show: true },
        { key: 'partNumber', show: true },
        { key: 'partname', show: true },
        { key: 'refMel', show: true },
