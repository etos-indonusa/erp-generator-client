...
import { InternalGrnReportService, InternalGrnService } from 'src/sdk/core/services';
import { AmimsInternalGrnDto } from 'src/sdk/core/models';
...
@Component({
    selector: 'app-internal-grn-share-list',
    templateUrl: './internal-grn-share-list.component.html',
    styleUrl: './internal-grn-share-list.component.scss'
})
export class InternalGrnShareListComponent {
  ...
  validasiMax: null
    ...
    searchData(reset: boolean = false): void {
        ...
        finalFilter[`id_internal_grn`] = { isNotNull: 'aktif' };

        this.internalGrnReportService.internalGrnReportControllerFindAll({
            body: {
                filter: finalFilter,
                joinWhere: [
                                        {
  ...
  },
  {
    ...
    onColumnToggle(): void {
        localStorage.setItem('internalGrn_columns', JSON.stringify(this.columns));
    }
