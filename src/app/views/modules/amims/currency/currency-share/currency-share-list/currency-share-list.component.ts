...
import { CurrencyReportService, CurrencyService } from 'src/sdk/core/services';
import { AmimsCurrencyDto } from 'src/sdk/core/models';
...
export class CurrencyShareListComponent {
  ...
  usdRateMax: null
    ...
    search_field: string[] = ["code","currency"];
  ...
  usdRateMax: null
    ...
    columns = [ 
         { key: 'code',  show: true },
              ...
              { key: 'currency',  show: true },
              { key: 'isDeleted',  show: true },
              { key: 'statusCurrency',  show: true },
              { key: 'updatedAt',  show: true },
              { key: 'usdRate',  show: true },
