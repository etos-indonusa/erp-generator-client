...
export function engineerPrisItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
