...
export function logUserControllerUpdate(http: HttpClient, rootUrl: string, params: LogUserControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
