...
export function doctypeControllerRemove(http: HttpClient, rootUrl: string, params: DoctypeControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
