...
export function engineerRtiWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerRtiWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
