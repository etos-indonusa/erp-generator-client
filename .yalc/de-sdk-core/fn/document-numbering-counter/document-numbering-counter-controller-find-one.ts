...
export function documentNumberingCounterControllerFindOne(http: HttpClient, rootUrl: string, params: DocumentNumberingCounterControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
