...
export function partLogControllerUpdate(http: HttpClient, rootUrl: string, params: PartLogControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
