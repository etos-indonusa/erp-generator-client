...
export function purVendorItemControllerFindOne(http: HttpClient, rootUrl: string, params: PurVendorItemControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
