...
export function logTransferWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogTransferWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
