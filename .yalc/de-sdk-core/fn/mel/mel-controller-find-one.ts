...
export function melControllerFindOne(http: HttpClient, rootUrl: string, params: MelControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMelDto;
}>> {
