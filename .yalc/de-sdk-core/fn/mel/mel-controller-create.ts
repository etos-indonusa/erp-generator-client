...
export function melControllerCreate(http: HttpClient, rootUrl: string, params: MelControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMelDto;
}>> {
