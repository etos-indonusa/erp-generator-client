...
export function tdDetailReportControllerFindAll(http: HttpClient, rootUrl: string, params: TdDetailReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
