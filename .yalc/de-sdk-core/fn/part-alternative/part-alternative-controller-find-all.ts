...
export function partAlternativeControllerFindAll(http: HttpClient, rootUrl: string, params?: PartAlternativeControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
