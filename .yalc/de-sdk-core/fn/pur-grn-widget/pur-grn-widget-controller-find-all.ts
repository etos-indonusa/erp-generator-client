...
export function purGrnWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurGrnWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
