...
export function warrantyControllerFindAll(http: HttpClient, rootUrl: string, params?: WarrantyControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
