...
export function pilotControllerUpdate(http: HttpClient, rootUrl: string, params: PilotControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPilotDto;
}>> {
