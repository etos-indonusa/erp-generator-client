...
export function mpcJoOperatorReportControllerFindAll(http: HttpClient, rootUrl: string, params: MpcJoOperatorReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
