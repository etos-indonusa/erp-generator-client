...
export function purPrControllerUpdate(http: HttpClient, rootUrl: string, params: PurPrControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPurPrDto;
}>> {
