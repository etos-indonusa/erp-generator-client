...
export function logProcessControllerFindAll(http: HttpClient, rootUrl: string, params?: LogProcessControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
