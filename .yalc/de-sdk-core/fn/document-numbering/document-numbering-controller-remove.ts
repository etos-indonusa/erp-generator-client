...
export function documentNumberingControllerRemove(http: HttpClient, rootUrl: string, params: DocumentNumberingControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
