...
export function partidReportControllerFindAll(http: HttpClient, rootUrl: string, params: PartidReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
