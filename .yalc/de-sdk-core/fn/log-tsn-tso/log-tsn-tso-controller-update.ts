...
export function logTsnTsoControllerUpdate(http: HttpClient, rootUrl: string, params: LogTsnTsoControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
