...
export function currencyReportControllerFindOne(http: HttpClient, rootUrl: string, params: CurrencyReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
