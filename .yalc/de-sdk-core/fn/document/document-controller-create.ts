...
export function documentControllerCreate(http: HttpClient, rootUrl: string, params: DocumentControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
