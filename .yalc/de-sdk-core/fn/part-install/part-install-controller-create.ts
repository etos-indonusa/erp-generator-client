...
export function partInstallControllerCreate(http: HttpClient, rootUrl: string, params: PartInstallControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
