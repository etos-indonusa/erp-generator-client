...
export function logSpControllerRemove(http: HttpClient, rootUrl: string, params: LogSpControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsLogSpDto;
}>> {
