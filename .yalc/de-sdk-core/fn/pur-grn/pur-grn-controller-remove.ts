...
export function purGrnControllerRemove(http: HttpClient, rootUrl: string, params: PurGrnControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPurGrnDto;
}>> {
