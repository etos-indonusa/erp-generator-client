...
export function mpcWpControllerFindOne(http: HttpClient, rootUrl: string, params: MpcWpControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpcWpDto;
}>> {
