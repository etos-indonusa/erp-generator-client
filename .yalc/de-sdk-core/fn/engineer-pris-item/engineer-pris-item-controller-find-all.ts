...
export function engineerPrisItemControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerPrisItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
