...
export function siteControllerUpdate(http: HttpClient, rootUrl: string, params: SiteControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsSiteDto;
}>> {
