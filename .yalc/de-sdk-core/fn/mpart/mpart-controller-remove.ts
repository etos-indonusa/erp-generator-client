...
export function mpartControllerRemove(http: HttpClient, rootUrl: string, params: MpartControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpartDto;
}>> {
