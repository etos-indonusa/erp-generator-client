...
export function lastMaintenanceControllerFindOne(http: HttpClient, rootUrl: string, params: LastMaintenanceControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
