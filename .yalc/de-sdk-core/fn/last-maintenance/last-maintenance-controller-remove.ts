...
export function lastMaintenanceControllerRemove(http: HttpClient, rootUrl: string, params: LastMaintenanceControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
