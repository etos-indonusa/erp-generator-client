...
export function techLogEngineCheckControllerCreate(http: HttpClient, rootUrl: string, params: TechLogEngineCheckControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
