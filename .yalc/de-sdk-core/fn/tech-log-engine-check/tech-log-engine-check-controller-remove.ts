...
export function techLogEngineCheckControllerRemove(http: HttpClient, rootUrl: string, params: TechLogEngineCheckControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
