...
export function purVendorItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurVendorItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
