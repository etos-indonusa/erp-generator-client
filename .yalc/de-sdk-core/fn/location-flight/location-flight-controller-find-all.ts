...
export function locationFlightControllerFindAll(http: HttpClient, rootUrl: string, params?: LocationFlightControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
