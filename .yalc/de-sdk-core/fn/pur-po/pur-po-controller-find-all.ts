...
export function purPoControllerFindAll(http: HttpClient, rootUrl: string, params?: PurPoControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
