...
export function purPoControllerRemove(http: HttpClient, rootUrl: string, params: PurPoControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPurPoDto;
}>> {
