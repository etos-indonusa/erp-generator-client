...
export function partControllerFindAll(http: HttpClient, rootUrl: string, params?: PartControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
