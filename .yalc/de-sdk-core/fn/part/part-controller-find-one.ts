...
export function partControllerFindOne(http: HttpClient, rootUrl: string, params: PartControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPartDto;
}>> {
