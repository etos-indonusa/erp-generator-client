...
export function logSpWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogSpWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
