...
export function engineerRtiPartControllerCreate(http: HttpClient, rootUrl: string, params: EngineerRtiPartControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
