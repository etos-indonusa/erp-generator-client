...
export function qaRpdReportControllerFindOne(http: HttpClient, rootUrl: string, params: QaRpdReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
