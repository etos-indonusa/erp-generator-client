...
export function logTransferControllerFindOne(http: HttpClient, rootUrl: string, params: LogTransferControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
