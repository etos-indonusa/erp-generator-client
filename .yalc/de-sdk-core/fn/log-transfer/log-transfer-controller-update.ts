...
export function logTransferControllerUpdate(http: HttpClient, rootUrl: string, params: LogTransferControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
