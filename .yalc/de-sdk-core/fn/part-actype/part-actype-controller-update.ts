...
export function partActypeControllerUpdate(http: HttpClient, rootUrl: string, params: PartActypeControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
