...
export function engineerPmtrItemControllerRemove(http: HttpClient, rootUrl: string, params: EngineerPmtrItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
