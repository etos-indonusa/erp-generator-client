...
export function actypeControllerFindOne(http: HttpClient, rootUrl: string, params: ActypeControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsActypeDto;
}>> {
