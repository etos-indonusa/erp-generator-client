...
export function maintenanceCodeControllerCreate(http: HttpClient, rootUrl: string, params: MaintenanceCodeControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
