...
export function shippingControllerRemove(http: HttpClient, rootUrl: string, params: ShippingControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
