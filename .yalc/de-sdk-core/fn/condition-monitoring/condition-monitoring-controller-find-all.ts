...
export function conditionMonitoringControllerFindAll(http: HttpClient, rootUrl: string, params?: ConditionMonitoringControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
