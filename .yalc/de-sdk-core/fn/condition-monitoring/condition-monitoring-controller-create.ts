...
export function conditionMonitoringControllerCreate(http: HttpClient, rootUrl: string, params: ConditionMonitoringControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
