...
export function partAlternativeReportControllerFindAll(http: HttpClient, rootUrl: string, params: PartAlternativeReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
