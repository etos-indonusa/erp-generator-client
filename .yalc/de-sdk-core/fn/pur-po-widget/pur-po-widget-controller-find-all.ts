...
export function purPoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurPoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
