...
export function aircraftControllerUpdate(http: HttpClient, rootUrl: string, params: AircraftControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
