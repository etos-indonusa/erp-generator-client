...
export function workflowAggregatorControllerRemove(http: HttpClient, rootUrl: string, params: WorkflowAggregatorControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
