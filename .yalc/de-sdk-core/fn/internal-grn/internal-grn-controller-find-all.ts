...
export function internalGrnControllerFindAll(http: HttpClient, rootUrl: string, params?: InternalGrnControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
