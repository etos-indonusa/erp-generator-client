...
export function typeOfworkControllerFindOne(http: HttpClient, rootUrl: string, params: TypeOfworkControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
