...
export function typeOfworkControllerCreate(http: HttpClient, rootUrl: string, params: TypeOfworkControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
