...
export function internalGrnItemControllerFindAll(http: HttpClient, rootUrl: string, params?: InternalGrnItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
