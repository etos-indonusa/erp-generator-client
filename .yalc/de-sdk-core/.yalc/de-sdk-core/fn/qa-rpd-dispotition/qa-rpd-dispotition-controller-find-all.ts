...
export function qaRpdDispotitionControllerFindAll(http: HttpClient, rootUrl: string, params?: QaRpdDispotitionControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
