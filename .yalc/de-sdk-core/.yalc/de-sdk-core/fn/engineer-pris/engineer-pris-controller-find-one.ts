...
export function engineerPrisControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPrisControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
