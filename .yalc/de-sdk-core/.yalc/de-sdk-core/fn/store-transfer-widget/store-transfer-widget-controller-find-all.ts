...
export function storeTransferWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StoreTransferWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
