...
export function storeDestroyControllerFindOne(http: HttpClient, rootUrl: string, params: StoreDestroyControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
