...
export function locationFlightWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LocationFlightWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
