...
export function typeOfworkWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TypeOfworkWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
