...
export function workflowLogControllerUpdate(http: HttpClient, rootUrl: string, params: WorkflowLogControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
