...
export function partidControllerFindOne(http: HttpClient, rootUrl: string, params: PartidControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPartidDto;
}>> {
