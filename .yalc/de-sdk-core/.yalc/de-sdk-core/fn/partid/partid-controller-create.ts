...
export function partidControllerCreate(http: HttpClient, rootUrl: string, params: PartidControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPartidDto;
}>> {
