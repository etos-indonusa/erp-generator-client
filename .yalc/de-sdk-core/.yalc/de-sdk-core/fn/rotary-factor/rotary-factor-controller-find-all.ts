...
export function rotaryFactorControllerFindAll(http: HttpClient, rootUrl: string, params?: RotaryFactorControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
