...
export function tdTypeControllerFindAll(http: HttpClient, rootUrl: string, params?: TdTypeControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
