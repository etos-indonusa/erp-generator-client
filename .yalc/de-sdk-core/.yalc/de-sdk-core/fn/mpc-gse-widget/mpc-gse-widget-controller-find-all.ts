...
export function mpcGseWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcGseWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
