...
export function binControllerFindAll(http: HttpClient, rootUrl: string, params?: BinControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
