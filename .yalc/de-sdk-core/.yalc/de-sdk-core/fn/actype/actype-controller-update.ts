...
export function actypeControllerUpdate(http: HttpClient, rootUrl: string, params: ActypeControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsActypeDto;
}>> {
