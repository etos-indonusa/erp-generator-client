...
export function pilotReportControllerFindOne(http: HttpClient, rootUrl: string, params: PilotReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
