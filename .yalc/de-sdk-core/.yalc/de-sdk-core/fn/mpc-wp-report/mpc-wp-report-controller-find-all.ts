...
export function mpcWpReportControllerFindAll(http: HttpClient, rootUrl: string, params: MpcWpReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
