...
export function documentNumberingCounterControllerFindAll(http: HttpClient, rootUrl: string, params?: DocumentNumberingCounterControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
