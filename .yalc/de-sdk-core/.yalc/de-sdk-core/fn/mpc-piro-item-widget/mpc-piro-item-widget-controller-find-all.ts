...
export function mpcPiroItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcPiroItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
