...
export function aircraftDetailWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: AircraftDetailWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
