...
export function mpcJoOperatorControllerFindAll(http: HttpClient, rootUrl: string, params?: MpcJoOperatorControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
