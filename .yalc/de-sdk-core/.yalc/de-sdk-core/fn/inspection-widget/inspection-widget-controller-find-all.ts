...
export function inspectionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: InspectionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
