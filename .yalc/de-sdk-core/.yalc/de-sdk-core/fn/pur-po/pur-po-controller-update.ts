...
export function purPoControllerUpdate(http: HttpClient, rootUrl: string, params: PurPoControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPurPoDto;
}>> {
