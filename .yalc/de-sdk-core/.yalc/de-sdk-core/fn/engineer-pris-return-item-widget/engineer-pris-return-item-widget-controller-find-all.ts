...
export function engineerPrisReturnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisReturnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
