...
export function aircraftDetailControllerFindOne(http: HttpClient, rootUrl: string, params: AircraftDetailControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
