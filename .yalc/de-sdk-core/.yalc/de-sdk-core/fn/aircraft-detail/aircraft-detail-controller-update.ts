...
export function aircraftDetailControllerUpdate(http: HttpClient, rootUrl: string, params: AircraftDetailControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
