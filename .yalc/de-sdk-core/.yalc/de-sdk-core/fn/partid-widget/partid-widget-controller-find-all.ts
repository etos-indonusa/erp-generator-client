...
export function partidWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartidWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
