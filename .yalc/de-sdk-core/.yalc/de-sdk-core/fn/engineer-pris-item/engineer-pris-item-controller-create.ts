...
export function engineerPrisItemControllerCreate(http: HttpClient, rootUrl: string, params: EngineerPrisItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
