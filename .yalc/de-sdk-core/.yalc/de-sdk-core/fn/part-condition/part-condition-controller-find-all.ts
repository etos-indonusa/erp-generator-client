...
export function partConditionControllerFindAll(http: HttpClient, rootUrl: string, params?: PartConditionControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
