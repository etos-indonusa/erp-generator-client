...
export function partConditionControllerRemove(http: HttpClient, rootUrl: string, params: PartConditionControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
