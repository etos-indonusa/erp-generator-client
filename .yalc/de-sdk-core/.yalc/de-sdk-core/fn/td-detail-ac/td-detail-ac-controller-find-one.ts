...
export function tdDetailAcControllerFindOne(http: HttpClient, rootUrl: string, params: TdDetailAcControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
