...
export function partControllerRemove(http: HttpClient, rootUrl: string, params: PartControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPartDto;
}>> {
