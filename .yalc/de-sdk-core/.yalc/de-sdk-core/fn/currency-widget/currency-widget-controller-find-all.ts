...
export function currencyWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: CurrencyWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
