...
export function qaTransferControllerRemove(http: HttpClient, rootUrl: string, params: QaTransferControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
