...
export function purPrItemControllerFindAll(http: HttpClient, rootUrl: string, params?: PurPrItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
