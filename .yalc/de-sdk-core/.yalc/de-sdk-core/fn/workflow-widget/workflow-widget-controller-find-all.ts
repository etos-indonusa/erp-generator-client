...
export function workflowWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: WorkflowWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
