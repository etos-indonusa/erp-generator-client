...
export function typeOfworkControllerUpdate(http: HttpClient, rootUrl: string, params: TypeOfworkControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
