...
export function engineerRtiIdentifyWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerRtiIdentifyWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
