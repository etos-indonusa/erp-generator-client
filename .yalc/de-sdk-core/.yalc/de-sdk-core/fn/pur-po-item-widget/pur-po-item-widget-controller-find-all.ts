...
export function purPoItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurPoItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
