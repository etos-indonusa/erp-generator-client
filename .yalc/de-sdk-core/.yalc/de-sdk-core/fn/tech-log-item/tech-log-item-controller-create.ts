...
export function techLogItemControllerCreate(http: HttpClient, rootUrl: string, params: TechLogItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
