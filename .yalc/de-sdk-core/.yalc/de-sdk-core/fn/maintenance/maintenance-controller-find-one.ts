...
export function maintenanceControllerFindOne(http: HttpClient, rootUrl: string, params: MaintenanceControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
