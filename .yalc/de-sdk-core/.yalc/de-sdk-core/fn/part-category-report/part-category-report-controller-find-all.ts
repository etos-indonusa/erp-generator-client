...
export function partCategoryReportControllerFindAll(http: HttpClient, rootUrl: string, params: PartCategoryReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
