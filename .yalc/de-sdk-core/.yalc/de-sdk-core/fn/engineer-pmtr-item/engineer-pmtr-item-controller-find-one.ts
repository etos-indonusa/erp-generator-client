...
export function engineerPmtrItemControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPmtrItemControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
