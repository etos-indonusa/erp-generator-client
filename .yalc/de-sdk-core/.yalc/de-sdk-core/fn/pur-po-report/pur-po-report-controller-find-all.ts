...
export function purPoReportControllerFindAll(http: HttpClient, rootUrl: string, params: PurPoReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
