...
export function purVendorContactWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurVendorContactWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
