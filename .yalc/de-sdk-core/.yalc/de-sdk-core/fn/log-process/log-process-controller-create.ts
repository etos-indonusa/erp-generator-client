...
export function logProcessControllerCreate(http: HttpClient, rootUrl: string, params: LogProcessControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
