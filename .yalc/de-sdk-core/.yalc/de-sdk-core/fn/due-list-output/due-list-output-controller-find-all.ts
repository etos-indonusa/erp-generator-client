...
export function dueListOutputControllerFindAll(http: HttpClient, rootUrl: string, params?: DueListOutputControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
