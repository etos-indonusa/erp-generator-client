...
export function dueListOutputControllerRemove(http: HttpClient, rootUrl: string, params: DueListOutputControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
