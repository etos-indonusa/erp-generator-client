...
export function aircraftControllerFindAll(http: HttpClient, rootUrl: string, params?: AircraftControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
