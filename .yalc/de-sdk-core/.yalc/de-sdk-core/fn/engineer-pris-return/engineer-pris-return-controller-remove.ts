...
export function engineerPrisReturnControllerRemove(http: HttpClient, rootUrl: string, params: EngineerPrisReturnControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
