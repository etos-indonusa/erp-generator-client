...
export function engineerPrisReturnControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPrisReturnControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
