...
export function lastMaintenanceReportControllerFindAll(http: HttpClient, rootUrl: string, params: LastMaintenanceReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
