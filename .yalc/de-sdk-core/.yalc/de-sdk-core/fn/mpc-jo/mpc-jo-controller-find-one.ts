...
export function mpcJoControllerFindOne(http: HttpClient, rootUrl: string, params: MpcJoControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpcJoDto;
}>> {
