...
export declare function partAtaWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartAtaWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartAtaWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partAtaWidgetControllerFindAll {
    var PATH: string;
}
