...
export interface LocationFlightWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function locationFlightWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LocationFlightWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsLocationFlightWidgetDto>;
    'total'?: number;
}>>;
export declare namespace locationFlightWidgetControllerFindAll {
    var PATH: string;
}
