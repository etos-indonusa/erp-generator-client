...
export interface PartActypeWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partActypeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartActypeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartActypeWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partActypeWidgetControllerFindAll {
    var PATH: string;
}
