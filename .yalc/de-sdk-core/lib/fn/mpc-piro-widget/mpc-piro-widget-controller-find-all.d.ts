...
export interface MpcPiroWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function mpcPiroWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcPiroWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcPiroWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcPiroWidgetControllerFindAll {
    var PATH: string;
}
