...
export interface AircraftWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function aircraftWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: AircraftWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsAircraftWidgetDto>;
    'total'?: number;
}>>;
export declare namespace aircraftWidgetControllerFindAll {
    var PATH: string;
}
