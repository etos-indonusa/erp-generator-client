...
export interface PurPoWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purPoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurPoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurPoWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purPoWidgetControllerFindAll {
    var PATH: string;
}
