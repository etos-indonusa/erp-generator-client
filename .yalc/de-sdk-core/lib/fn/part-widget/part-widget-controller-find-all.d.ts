...
export interface PartWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partWidgetControllerFindAll {
    var PATH: string;
}
