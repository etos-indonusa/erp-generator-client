...
export interface PartConditionWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partConditionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartConditionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartConditionWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partConditionWidgetControllerFindAll {
    var PATH: string;
}
