...
export declare function partInstallOldWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartInstallOldWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartInstallOldWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partInstallOldWidgetControllerFindAll {
    var PATH: string;
}
