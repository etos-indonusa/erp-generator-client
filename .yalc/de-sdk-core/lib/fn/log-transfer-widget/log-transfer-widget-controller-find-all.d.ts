...
export interface LogTransferWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function logTransferWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogTransferWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsLogTransferWidgetDto>;
    'total'?: number;
}>>;
export declare namespace logTransferWidgetControllerFindAll {
    var PATH: string;
}
