...
export interface MpcPiroItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function mpcPiroItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcPiroItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcPiroItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcPiroItemWidgetControllerFindAll {
    var PATH: string;
}
