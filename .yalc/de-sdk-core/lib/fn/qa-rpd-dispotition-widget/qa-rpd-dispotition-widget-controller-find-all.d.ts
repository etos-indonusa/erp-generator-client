...
export interface QaRpdDispotitionWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function qaRpdDispotitionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaRpdDispotitionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsQaRpdDispotitionWidgetDto>;
    'total'?: number;
}>>;
export declare namespace qaRpdDispotitionWidgetControllerFindAll {
    var PATH: string;
}
