...
export interface TechLogEngineCheckWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function techLogEngineCheckWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogEngineCheckWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTechLogEngineCheckWidgetDto>;
    'total'?: number;
}>>;
export declare namespace techLogEngineCheckWidgetControllerFindAll {
    var PATH: string;
}
