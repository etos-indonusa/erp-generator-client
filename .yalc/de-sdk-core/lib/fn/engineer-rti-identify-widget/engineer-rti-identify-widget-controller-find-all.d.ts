...
export interface EngineerRtiIdentifyWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function engineerRtiIdentifyWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerRtiIdentifyWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerRtiIdentifyWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerRtiIdentifyWidgetControllerFindAll {
    var PATH: string;
}
