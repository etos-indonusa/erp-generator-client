...
export interface StoreTransferWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function storeTransferWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StoreTransferWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsStoreTransferWidgetDto>;
    'total'?: number;
}>>;
export declare namespace storeTransferWidgetControllerFindAll {
    var PATH: string;
}
