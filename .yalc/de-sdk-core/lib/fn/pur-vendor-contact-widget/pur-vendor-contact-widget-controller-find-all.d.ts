...
export interface PurVendorContactWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purVendorContactWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurVendorContactWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurVendorContactWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purVendorContactWidgetControllerFindAll {
    var PATH: string;
}
