...
export interface PilotWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function pilotWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PilotWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPilotWidgetDto>;
    'total'?: number;
}>>;
export declare namespace pilotWidgetControllerFindAll {
    var PATH: string;
}
