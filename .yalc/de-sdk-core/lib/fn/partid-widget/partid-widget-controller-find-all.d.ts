...
export interface PartidWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partidWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartidWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartidWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partidWidgetControllerFindAll {
    var PATH: string;
}
