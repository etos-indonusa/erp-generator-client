...
export declare function maintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMaintenanceWidgetDto>;
    'total'?: number;
}>>;
export declare namespace maintenanceWidgetControllerFindAll {
    var PATH: string;
}
