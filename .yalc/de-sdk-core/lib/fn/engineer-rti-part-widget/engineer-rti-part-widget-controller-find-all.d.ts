...
export interface EngineerRtiPartWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function engineerRtiPartWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerRtiPartWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerRtiPartWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerRtiPartWidgetControllerFindAll {
    var PATH: string;
}
