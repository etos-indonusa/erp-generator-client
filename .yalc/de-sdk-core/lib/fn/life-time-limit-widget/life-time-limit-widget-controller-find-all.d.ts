...
export interface LifeTimeLimitWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function lifeTimeLimitWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LifeTimeLimitWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsLifeTimeLimitWidgetDto>;
    'total'?: number;
}>>;
export declare namespace lifeTimeLimitWidgetControllerFindAll {
    var PATH: string;
}
