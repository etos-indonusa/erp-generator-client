...
export interface DueListOutputWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function dueListOutputWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: DueListOutputWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsDueListOutputWidgetDto>;
    'total'?: number;
}>>;
export declare namespace dueListOutputWidgetControllerFindAll {
    var PATH: string;
}
