...
export interface AircraftDetailWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function aircraftDetailWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: AircraftDetailWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsAircraftDetailWidgetDto>;
    'total'?: number;
}>>;
export declare namespace aircraftDetailWidgetControllerFindAll {
    var PATH: string;
}
