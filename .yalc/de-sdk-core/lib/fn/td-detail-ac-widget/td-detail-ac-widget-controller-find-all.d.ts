...
export interface TdDetailAcWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function tdDetailAcWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TdDetailAcWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTdDetailAcWidgetDto>;
    'total'?: number;
}>>;
export declare namespace tdDetailAcWidgetControllerFindAll {
    var PATH: string;
}
