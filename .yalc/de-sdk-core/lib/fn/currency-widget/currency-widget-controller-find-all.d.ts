...
export interface CurrencyWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function currencyWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: CurrencyWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsCurrencyWidgetDto>;
    'total'?: number;
}>>;
export declare namespace currencyWidgetControllerFindAll {
    var PATH: string;
}
