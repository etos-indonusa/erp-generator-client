...
export interface PurPrclWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purPrclWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurPrclWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurPrclWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purPrclWidgetControllerFindAll {
    var PATH: string;
}
