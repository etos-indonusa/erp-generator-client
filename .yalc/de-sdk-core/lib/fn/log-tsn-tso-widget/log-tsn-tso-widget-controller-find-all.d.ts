...
export interface LogTsnTsoWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function logTsnTsoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogTsnTsoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsLogTsnTsoWidgetDto>;
    'total'?: number;
}>>;
export declare namespace logTsnTsoWidgetControllerFindAll {
    var PATH: string;
}
