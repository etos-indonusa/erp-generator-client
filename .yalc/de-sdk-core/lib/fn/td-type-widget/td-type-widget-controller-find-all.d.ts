...
export interface TdTypeWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function tdTypeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TdTypeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTdTypeWidgetDto>;
    'total'?: number;
}>>;
export declare namespace tdTypeWidgetControllerFindAll {
    var PATH: string;
}
