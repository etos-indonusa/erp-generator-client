...
export interface PurGrnWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purGrnWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurGrnWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurGrnWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purGrnWidgetControllerFindAll {
    var PATH: string;
}
