...
export interface EngineerPrisItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function engineerPrisItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerPrisItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerPrisItemWidgetControllerFindAll {
    var PATH: string;
}
