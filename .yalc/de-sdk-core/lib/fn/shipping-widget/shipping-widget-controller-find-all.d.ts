...
export declare function shippingWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: ShippingWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsShippingWidgetDto>;
    'total'?: number;
}>>;
export declare namespace shippingWidgetControllerFindAll {
    var PATH: string;
}
