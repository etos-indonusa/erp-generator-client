...
export interface LastMaintenanceWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function lastMaintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LastMaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsLastMaintenanceWidgetDto>;
    'total'?: number;
}>>;
export declare namespace lastMaintenanceWidgetControllerFindAll {
    var PATH: string;
}
