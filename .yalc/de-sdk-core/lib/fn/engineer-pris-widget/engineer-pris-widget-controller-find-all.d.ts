...
export declare function engineerPrisWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerPrisWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerPrisWidgetControllerFindAll {
    var PATH: string;
}
