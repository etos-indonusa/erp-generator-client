...
export declare function techLogWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTechLogWidgetDto>;
    'total'?: number;
}>>;
export declare namespace techLogWidgetControllerFindAll {
    var PATH: string;
}
