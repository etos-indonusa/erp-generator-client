...
export interface MpcSelfMaintenanceWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function mpcSelfMaintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcSelfMaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcSelfMaintenanceWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcSelfMaintenanceWidgetControllerFindAll {
    var PATH: string;
}
