...
export interface TechLogItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function techLogItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTechLogItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace techLogItemWidgetControllerFindAll {
    var PATH: string;
}
