...
export interface BinWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function binWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: BinWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsBinWidgetDto>;
    'total'?: number;
}>>;
export declare namespace binWidgetControllerFindAll {
    var PATH: string;
}
