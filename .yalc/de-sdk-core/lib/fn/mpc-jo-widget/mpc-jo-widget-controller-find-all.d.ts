...
export interface MpcJoWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function mpcJoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcJoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcJoWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcJoWidgetControllerFindAll {
    var PATH: string;
}
