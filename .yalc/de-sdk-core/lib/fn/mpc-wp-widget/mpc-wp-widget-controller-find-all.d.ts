...
export declare function mpcWpWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcWpWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcWpWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcWpWidgetControllerFindAll {
    var PATH: string;
}
