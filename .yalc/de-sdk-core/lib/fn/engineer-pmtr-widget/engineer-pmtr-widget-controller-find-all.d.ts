...
export interface EngineerPmtrWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function engineerPmtrWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPmtrWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerPmtrWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerPmtrWidgetControllerFindAll {
    var PATH: string;
}
