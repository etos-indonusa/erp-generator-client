...
export interface StoreTransferItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function storeTransferItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StoreTransferItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsStoreTransferItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace storeTransferItemWidgetControllerFindAll {
    var PATH: string;
}
