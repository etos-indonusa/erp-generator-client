...
export interface TdWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function tdWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TdWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTdWidgetDto>;
    'total'?: number;
}>>;
export declare namespace tdWidgetControllerFindAll {
    var PATH: string;
}
