...
export interface PartCategoryWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partCategoryWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartCategoryWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartCategoryWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partCategoryWidgetControllerFindAll {
    var PATH: string;
}
