...
export interface QaTransferItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function qaTransferItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaTransferItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsQaTransferItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace qaTransferItemWidgetControllerFindAll {
    var PATH: string;
}
