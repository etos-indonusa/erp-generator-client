...
export interface PurReturnItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purReturnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurReturnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurReturnItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purReturnItemWidgetControllerFindAll {
    var PATH: string;
}
