...
export interface TechLogJoWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function techLogJoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogJoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsTechLogJoWidgetDto>;
    'total'?: number;
}>>;
export declare namespace techLogJoWidgetControllerFindAll {
    var PATH: string;
}
