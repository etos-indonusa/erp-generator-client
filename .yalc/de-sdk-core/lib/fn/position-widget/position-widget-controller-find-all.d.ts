...
export interface PositionWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function positionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PositionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPositionWidgetDto>;
    'total'?: number;
}>>;
export declare namespace positionWidgetControllerFindAll {
    var PATH: string;
}
