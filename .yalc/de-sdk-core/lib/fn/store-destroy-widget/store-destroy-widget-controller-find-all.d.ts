...
export declare function storeDestroyWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: StoreDestroyWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsStoreDestroyWidgetDto>;
    'total'?: number;
}>>;
export declare namespace storeDestroyWidgetControllerFindAll {
    var PATH: string;
}
