...
export interface PartFigureIndexWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partFigureIndexWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartFigureIndexWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartFigureIndexWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partFigureIndexWidgetControllerFindAll {
    var PATH: string;
}
