...
export declare function purGrnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurGrnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurGrnItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purGrnItemWidgetControllerFindAll {
    var PATH: string;
}
