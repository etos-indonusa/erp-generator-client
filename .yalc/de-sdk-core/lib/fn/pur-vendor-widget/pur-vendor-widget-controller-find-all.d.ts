...
export interface PurVendorWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function purVendorWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurVendorWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPurVendorWidgetDto>;
    'total'?: number;
}>>;
export declare namespace purVendorWidgetControllerFindAll {
    var PATH: string;
}
