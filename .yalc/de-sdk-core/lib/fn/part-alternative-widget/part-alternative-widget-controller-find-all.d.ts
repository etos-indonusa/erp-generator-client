...
export interface PartAlternativeWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function partAlternativeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartAlternativeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsPartAlternativeWidgetDto>;
    'total'?: number;
}>>;
export declare namespace partAlternativeWidgetControllerFindAll {
    var PATH: string;
}
