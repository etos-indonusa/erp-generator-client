...
export interface MpcGseWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function mpcGseWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcGseWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsMpcGseWidgetDto>;
    'total'?: number;
}>>;
export declare namespace mpcGseWidgetControllerFindAll {
    var PATH: string;
}
