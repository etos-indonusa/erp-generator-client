...
export interface EngineerPrisReturnItemWidgetControllerFindAll$Params {
    /**
     * Filter object
     */
    filter?: Object;
...
export declare function engineerPrisReturnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisReturnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
    'code'?: number;
    'pesan'?: string;
    'data'?: Array<AmimsEngineerPrisReturnItemWidgetDto>;
    'total'?: number;
}>>;
export declare namespace engineerPrisReturnItemWidgetControllerFindAll {
    var PATH: string;
}
