...
export function conditionMonitoringControllerRemove(http: HttpClient, rootUrl: string, params: ConditionMonitoringControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
