...
export function positionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PositionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
