...
export function techDefectControllerFindAll(http: HttpClient, rootUrl: string, params?: TechDefectControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
