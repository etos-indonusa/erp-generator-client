...
export function techDefectControllerRemove(http: HttpClient, rootUrl: string, params: TechDefectControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
