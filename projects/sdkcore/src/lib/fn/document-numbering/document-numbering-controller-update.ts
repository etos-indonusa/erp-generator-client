...
export function documentNumberingControllerUpdate(http: HttpClient, rootUrl: string, params: DocumentNumberingControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
