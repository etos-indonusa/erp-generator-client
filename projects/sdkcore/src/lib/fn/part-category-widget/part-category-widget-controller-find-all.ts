...
export function partCategoryWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartCategoryWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
