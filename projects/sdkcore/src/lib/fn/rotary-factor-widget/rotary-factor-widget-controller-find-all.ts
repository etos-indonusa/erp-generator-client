...
export function rotaryFactorWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: RotaryFactorWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
