...
export function internalGrnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: InternalGrnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
