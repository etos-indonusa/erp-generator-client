...
export function qaRpdControllerFindOne(http: HttpClient, rootUrl: string, params: QaRpdControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsQaRpdDto;
}>> {
