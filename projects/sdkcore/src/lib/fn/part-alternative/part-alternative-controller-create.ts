...
export function partAlternativeControllerCreate(http: HttpClient, rootUrl: string, params: PartAlternativeControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
