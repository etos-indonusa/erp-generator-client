...
export function partAlternativeControllerRemove(http: HttpClient, rootUrl: string, params: PartAlternativeControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
