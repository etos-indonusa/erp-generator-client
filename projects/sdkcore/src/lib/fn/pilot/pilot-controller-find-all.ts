...
export function pilotControllerFindAll(http: HttpClient, rootUrl: string, params?: PilotControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
