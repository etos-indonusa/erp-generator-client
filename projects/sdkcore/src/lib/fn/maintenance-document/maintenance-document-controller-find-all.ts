...
export interface MaintenanceDocumentControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function maintenanceDocumentControllerFindAll(http: HttpClient, rootUrl: string, params?: MaintenanceDocumentControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
