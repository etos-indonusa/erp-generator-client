...
export interface MaintenanceDocumentControllerUpdate$Params {
  id: string;
      body: AmimsMaintenanceDocumentDto
}

export function maintenanceDocumentControllerUpdate(http: HttpClient, rootUrl: string, params: MaintenanceDocumentControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
