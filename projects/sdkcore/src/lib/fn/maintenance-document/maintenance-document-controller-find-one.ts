...
export interface MaintenanceDocumentControllerFindOne$Params {
  id: string;
}

export function maintenanceDocumentControllerFindOne(http: HttpClient, rootUrl: string, params: MaintenanceDocumentControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
