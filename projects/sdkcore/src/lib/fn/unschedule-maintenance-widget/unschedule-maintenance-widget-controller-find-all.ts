...
export interface UnscheduleMaintenanceWidgetControllerFindAll$Params {
...
export function unscheduleMaintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: UnscheduleMaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
