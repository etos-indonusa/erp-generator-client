...
export function engineerPrisReturnItemControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPrisReturnItemControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
