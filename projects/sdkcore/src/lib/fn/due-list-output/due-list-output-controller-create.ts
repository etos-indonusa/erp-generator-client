...
export function dueListOutputControllerCreate(http: HttpClient, rootUrl: string, params: DueListOutputControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
