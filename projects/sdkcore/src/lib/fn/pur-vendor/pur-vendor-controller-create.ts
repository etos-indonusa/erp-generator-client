...
export function purVendorControllerCreate(http: HttpClient, rootUrl: string, params: PurVendorControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
