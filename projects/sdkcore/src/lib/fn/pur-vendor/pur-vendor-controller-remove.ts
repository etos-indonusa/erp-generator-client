...
export function purVendorControllerRemove(http: HttpClient, rootUrl: string, params: PurVendorControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
