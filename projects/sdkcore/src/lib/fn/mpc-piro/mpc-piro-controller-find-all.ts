...
export function mpcPiroControllerFindAll(http: HttpClient, rootUrl: string, params?: MpcPiroControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
