...
export function tdTypeReportControllerFindAll(http: HttpClient, rootUrl: string, params: TdTypeReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
