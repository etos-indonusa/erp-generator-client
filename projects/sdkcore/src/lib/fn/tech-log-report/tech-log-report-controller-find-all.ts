...
export function techLogReportControllerFindAll(http: HttpClient, rootUrl: string, params: TechLogReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
