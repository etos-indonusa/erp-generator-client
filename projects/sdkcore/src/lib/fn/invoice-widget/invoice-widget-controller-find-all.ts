...
export function invoiceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: InvoiceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
...
invoiceWidgetControllerFindAll.PATH = '/auth/invoice/invoice_widget';
