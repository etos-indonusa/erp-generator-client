...
export function logSpReportControllerFindAll(http: HttpClient, rootUrl: string, params: LogSpReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
