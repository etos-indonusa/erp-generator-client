...
export function workflowAggregatorControllerFindAll(http: HttpClient, rootUrl: string, params?: WorkflowAggregatorControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
