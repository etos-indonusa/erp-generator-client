...
export function qaRpdDispotitionControllerUpdate(http: HttpClient, rootUrl: string, params: QaRpdDispotitionControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
