...
export function storeTransferItemControllerFindAll(http: HttpClient, rootUrl: string, params?: StoreTransferItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
