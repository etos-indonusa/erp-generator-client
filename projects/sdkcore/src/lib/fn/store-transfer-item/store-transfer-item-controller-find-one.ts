...
export function storeTransferItemControllerFindOne(http: HttpClient, rootUrl: string, params: StoreTransferItemControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
