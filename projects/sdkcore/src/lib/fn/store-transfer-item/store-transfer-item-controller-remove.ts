...
export function storeTransferItemControllerRemove(http: HttpClient, rootUrl: string, params: StoreTransferItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
