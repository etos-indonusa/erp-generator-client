...
export function partidControllerRemove(http: HttpClient, rootUrl: string, params: PartidControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsPartidDto;
}>> {
