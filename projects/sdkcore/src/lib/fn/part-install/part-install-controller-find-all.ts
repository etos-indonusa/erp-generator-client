...
export function partInstallControllerFindAll(http: HttpClient, rootUrl: string, params?: PartInstallControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
