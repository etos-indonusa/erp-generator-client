...
export function partInstallControllerUpdate(http: HttpClient, rootUrl: string, params: PartInstallControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
