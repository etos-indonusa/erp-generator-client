...
export function qaTransferItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaTransferItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
