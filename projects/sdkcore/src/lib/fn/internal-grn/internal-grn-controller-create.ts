...
export function internalGrnControllerCreate(http: HttpClient, rootUrl: string, params: InternalGrnControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
