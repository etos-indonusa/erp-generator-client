...
export function internalGrnWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: InternalGrnWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
