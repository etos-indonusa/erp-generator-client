...
export function tdDetailControllerUpdate(http: HttpClient, rootUrl: string, params: TdDetailControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
