...
export function engineerRtiPartControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerRtiPartControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
