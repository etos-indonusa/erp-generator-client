...
export function customFieldValueWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: CustomFieldValueWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
