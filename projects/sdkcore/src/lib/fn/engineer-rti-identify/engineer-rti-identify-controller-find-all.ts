...
export function engineerRtiIdentifyControllerFindAll(http: HttpClient, rootUrl: string, params?: EngineerRtiIdentifyControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
