...
export function tdRefControllerCreate(http: HttpClient, rootUrl: string, params: TdRefControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsTdRefDto;
}>> {
