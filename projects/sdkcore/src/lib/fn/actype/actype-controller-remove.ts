...
export function actypeControllerRemove(http: HttpClient, rootUrl: string, params: ActypeControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsActypeDto;
}>> {
