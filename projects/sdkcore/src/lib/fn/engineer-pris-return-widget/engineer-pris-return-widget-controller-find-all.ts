...
export function engineerPrisReturnWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: EngineerPrisReturnWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
