...
export function partConditionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartConditionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
