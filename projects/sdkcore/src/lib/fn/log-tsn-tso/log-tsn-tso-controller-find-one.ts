...
export function logTsnTsoControllerFindOne(http: HttpClient, rootUrl: string, params: LogTsnTsoControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
