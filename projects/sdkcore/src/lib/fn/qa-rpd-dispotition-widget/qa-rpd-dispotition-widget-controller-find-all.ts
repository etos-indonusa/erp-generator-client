...
export function qaRpdDispotitionWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: QaRpdDispotitionWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
