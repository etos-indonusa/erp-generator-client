...
export function customFieldGroupWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: CustomFieldGroupWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
