...
export function mpcSelfMaintenanceWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MpcSelfMaintenanceWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
