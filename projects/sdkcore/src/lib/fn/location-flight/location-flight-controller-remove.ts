...
export function locationFlightControllerRemove(http: HttpClient, rootUrl: string, params: LocationFlightControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
