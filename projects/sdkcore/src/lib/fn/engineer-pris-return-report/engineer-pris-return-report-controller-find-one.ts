...
export function engineerPrisReturnReportControllerFindOne(http: HttpClient, rootUrl: string, params: EngineerPrisReturnReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
