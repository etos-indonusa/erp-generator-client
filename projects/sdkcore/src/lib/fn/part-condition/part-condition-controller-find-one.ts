...
export function partConditionControllerFindOne(http: HttpClient, rootUrl: string, params: PartConditionControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
