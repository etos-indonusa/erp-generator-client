...
export function workflowStepWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: WorkflowStepWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
