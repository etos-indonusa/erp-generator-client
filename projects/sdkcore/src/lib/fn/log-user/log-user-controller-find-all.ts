...
export function logUserControllerFindAll(http: HttpClient, rootUrl: string, params?: LogUserControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
