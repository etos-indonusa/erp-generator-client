...
export function partLogControllerCreate(http: HttpClient, rootUrl: string, params: PartLogControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
