...
export function maintenanceCodeControllerFindOne(http: HttpClient, rootUrl: string, params: MaintenanceCodeControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
