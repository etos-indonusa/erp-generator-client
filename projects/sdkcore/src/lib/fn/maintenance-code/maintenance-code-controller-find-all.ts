...
export function maintenanceCodeControllerFindAll(http: HttpClient, rootUrl: string, params?: MaintenanceCodeControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
