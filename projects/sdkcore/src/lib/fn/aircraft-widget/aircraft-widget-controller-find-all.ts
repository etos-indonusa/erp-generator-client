...
export function aircraftWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: AircraftWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
