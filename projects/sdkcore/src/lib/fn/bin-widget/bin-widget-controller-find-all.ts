...
export function binWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: BinWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
