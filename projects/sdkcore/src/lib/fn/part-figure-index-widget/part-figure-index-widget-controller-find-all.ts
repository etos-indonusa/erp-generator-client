...
export function partFigureIndexWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartFigureIndexWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
