...
export function techLogJoControllerCreate(http: HttpClient, rootUrl: string, params: TechLogJoControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
