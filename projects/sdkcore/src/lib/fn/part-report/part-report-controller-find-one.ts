...
export function partReportControllerFindOne(http: HttpClient, rootUrl: string, params: PartReportControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
