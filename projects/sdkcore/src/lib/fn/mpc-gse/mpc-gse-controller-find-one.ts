...
export function mpcGseControllerFindOne(http: HttpClient, rootUrl: string, params: MpcGseControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: AmimsMpcGseDto;
}>> {
