...
export function purGrnItemControllerRemove(http: HttpClient, rootUrl: string, params: PurGrnItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
