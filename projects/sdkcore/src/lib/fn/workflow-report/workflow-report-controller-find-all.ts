...
export function workflowReportControllerFindAll(http: HttpClient, rootUrl: string, params: WorkflowReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
