...
export function partInstallOldControllerRemove(http: HttpClient, rootUrl: string, params: PartInstallOldControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
