...
export function partInstallOldControllerFindAll(http: HttpClient, rootUrl: string, params?: PartInstallOldControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
