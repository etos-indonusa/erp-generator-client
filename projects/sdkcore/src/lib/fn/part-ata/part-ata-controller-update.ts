...
export function partAtaControllerUpdate(http: HttpClient, rootUrl: string, params: PartAtaControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
