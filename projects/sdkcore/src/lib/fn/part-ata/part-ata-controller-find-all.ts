...
export function partAtaControllerFindAll(http: HttpClient, rootUrl: string, params?: PartAtaControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
