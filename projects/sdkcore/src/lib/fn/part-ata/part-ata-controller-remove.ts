...
export function partAtaControllerRemove(http: HttpClient, rootUrl: string, params: PartAtaControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
