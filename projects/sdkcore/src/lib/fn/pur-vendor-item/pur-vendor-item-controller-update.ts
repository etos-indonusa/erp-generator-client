...
export function purVendorItemControllerUpdate(http: HttpClient, rootUrl: string, params: PurVendorItemControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
