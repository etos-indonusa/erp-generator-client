...
export function purVendorItemControllerRemove(http: HttpClient, rootUrl: string, params: PurVendorItemControllerRemove$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
