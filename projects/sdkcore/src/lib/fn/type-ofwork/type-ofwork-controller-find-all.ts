...
export function typeOfworkControllerFindAll(http: HttpClient, rootUrl: string, params?: TypeOfworkControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
