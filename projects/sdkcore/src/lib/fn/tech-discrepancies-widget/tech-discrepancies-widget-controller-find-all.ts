...
export function techDiscrepanciesWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: TechDiscrepanciesWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
