...
export function mcurrencyControllerFindAll(http: HttpClient, rootUrl: string, params?: McurrencyControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
