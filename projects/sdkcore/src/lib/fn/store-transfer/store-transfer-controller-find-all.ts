...
export function storeTransferControllerFindAll(http: HttpClient, rootUrl: string, params?: StoreTransferControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
