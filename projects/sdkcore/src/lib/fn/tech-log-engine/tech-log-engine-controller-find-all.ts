...
export function techLogEngineControllerFindAll(http: HttpClient, rootUrl: string, params?: TechLogEngineControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
