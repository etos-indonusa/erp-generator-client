...
export function qaTransferControllerFindAll(http: HttpClient, rootUrl: string, params?: QaTransferControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
