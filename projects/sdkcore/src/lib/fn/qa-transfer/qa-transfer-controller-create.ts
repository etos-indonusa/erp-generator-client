...
export function qaTransferControllerCreate(http: HttpClient, rootUrl: string, params: QaTransferControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
