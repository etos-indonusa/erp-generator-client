...
export function figureIndexControllerFindOne(http: HttpClient, rootUrl: string, params: FigureIndexControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
