...
export function figureIndexControllerCreate(http: HttpClient, rootUrl: string, params: FigureIndexControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
