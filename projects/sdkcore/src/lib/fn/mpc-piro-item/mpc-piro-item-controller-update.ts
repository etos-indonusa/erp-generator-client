...
export function mpcPiroItemControllerUpdate(http: HttpClient, rootUrl: string, params: MpcPiroItemControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
