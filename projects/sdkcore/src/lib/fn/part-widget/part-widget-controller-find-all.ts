...
export function partWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PartWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
