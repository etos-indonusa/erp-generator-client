...
export function mpcJoControllerFindAll(http: HttpClient, rootUrl: string, params?: MpcJoControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
