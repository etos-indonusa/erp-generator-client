...
export function purPoItemControllerFindAll(http: HttpClient, rootUrl: string, params?: PurPoItemControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
