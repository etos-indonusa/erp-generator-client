...
export function purPoItemControllerCreate(http: HttpClient, rootUrl: string, params: PurPoItemControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
