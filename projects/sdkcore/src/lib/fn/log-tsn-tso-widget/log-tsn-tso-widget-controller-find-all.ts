...
export function logTsnTsoWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LogTsnTsoWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
