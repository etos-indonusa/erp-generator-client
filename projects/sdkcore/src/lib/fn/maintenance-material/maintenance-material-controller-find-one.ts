...
export interface MaintenanceMaterialControllerFindOne$Params {
  id: string;
}

export function maintenanceMaterialControllerFindOne(http: HttpClient, rootUrl: string, params: MaintenanceMaterialControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
