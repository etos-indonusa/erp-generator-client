...
export interface MaintenanceMaterialControllerCreate$Params {
      body: AmimsMaintenanceMaterialDto
}

export function maintenanceMaterialControllerCreate(http: HttpClient, rootUrl: string, params: MaintenanceMaterialControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
