...
export interface MaintenanceMaterialControllerFindAll$Params {
  pageIndex?: number;
  pageSize?: number;
...
export function maintenanceMaterialControllerFindAll(http: HttpClient, rootUrl: string, params?: MaintenanceMaterialControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
