...
export function customFieldGroupControllerFindAll(http: HttpClient, rootUrl: string, params?: CustomFieldGroupControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
