...
export function techLogEngineCheckControllerFindOne(http: HttpClient, rootUrl: string, params: TechLogEngineCheckControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
