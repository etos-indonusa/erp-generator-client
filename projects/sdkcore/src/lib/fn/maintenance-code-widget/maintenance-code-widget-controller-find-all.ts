...
export interface MaintenanceCodeWidgetControllerFindAll$Params {
...
export function maintenanceCodeWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: MaintenanceCodeWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
