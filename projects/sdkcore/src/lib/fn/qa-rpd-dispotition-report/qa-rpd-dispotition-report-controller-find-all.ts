...
export function qaRpdDispotitionReportControllerFindAll(http: HttpClient, rootUrl: string, params: QaRpdDispotitionReportControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
