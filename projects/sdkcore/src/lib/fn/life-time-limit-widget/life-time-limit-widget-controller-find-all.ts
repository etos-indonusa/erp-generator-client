...
export function lifeTimeLimitWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: LifeTimeLimitWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
