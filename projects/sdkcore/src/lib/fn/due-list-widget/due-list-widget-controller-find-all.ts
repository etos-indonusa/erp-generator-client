...
export function dueListWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: DueListWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
'data'?: Array<AmimsDueListWidgetDto>;
'total'?: number;
}>> {
  const rb = new RequestBuilder(rootUrl, dueListWidgetControllerFindAll.PATH, 'post');
  if (params) {
...
dueListWidgetControllerFindAll.PATH = '/amims/due_list/due_list_widget';
