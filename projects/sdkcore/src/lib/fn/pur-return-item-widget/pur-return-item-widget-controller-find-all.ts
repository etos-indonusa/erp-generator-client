...
export function purReturnItemWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: PurReturnItemWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
