...
export function dueListOutputWidgetControllerFindAll(http: HttpClient, rootUrl: string, params: DueListOutputWidgetControllerFindAll$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'code'?: number;
'pesan'?: string;
